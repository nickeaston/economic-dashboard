...
SECTIONS = [
    ...
    ("macro_economics", "Macro Economics", [
        {"id": "truflation", "title": "Truflation US Inflation",      "key": "truflation", "type": "line", "unit": "%"},
        {"id": "t10y2y",     "title": "10Y-2Y Treasury Spread",       "key": "t10y2y",     "type": "line", "unit": "%"},
        {"id": "gscpi",      "title": "NY Fed GSCPI",                 "key": "gscpi",      "type": "line", "unit": "z-score"},
        {"id": "tbill_3m",   "title": "3-Month T-Bill Yield",         "key": "tbill_3m",   "type": "line", "unit": "%"},
        {"id": "ism_pmi",    "title": "ISM Manufacturing PMI",        "key": "ism_pmi",    "type": "line", "unit": ""},
        {"id": "unrate",     "title": "US Unemployment Rate",         "key": "unrate",     "type": "line", "unit": "%"},
    ...
    ("crypto_mkt_cap", "Crypto Market Cap & AUM", [
        {"id": "tao_subnet",   "title": "TAO Bittensor — Market Cap",      "key": "tao_subnet",   "type": "line", "unit": "USD bn"},
